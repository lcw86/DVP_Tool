...
#define kNotificationReloadProfile  "NotificationReloadProfile"

#define kEngineProfilePath  "kEngineProfilePath"

#define kSNFirstBarcode     "kSNFirstBarcode"
#define kSNMlbSN            "kSNMlbSN"
#define kSNCfgSN            "kSNCfgSN"
